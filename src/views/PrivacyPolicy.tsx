...
const PrivacyPolicy  = () => {
  ...
  return (<Parallax ref={parallax} pages={isMobile ? 10 : 8} className={classNames('privacy-policy-container', { isMobile })}>
    ...
    <ParallaxLayer factor={1} className={classNames('privacy-policy', { isMobile })}>
      <Container>
